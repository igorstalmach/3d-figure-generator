...
export class GeometryGrammarParser extends Parser {
	...
	public static readonly ruleNames: string[] = [
		"command", "drawCmd", "shape", "sphere", "box", "pyramid", "size", "radius", 
...
export class SizeContext extends ParserRuleContext {
	public SIZE(): TerminalNode { return this.getToken(GeometryGrammarParser.SIZE, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
...
export class ColorContext extends ParserRuleContext {
	public COLOR(): TerminalNode { return this.getToken(GeometryGrammarParser.COLOR, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
